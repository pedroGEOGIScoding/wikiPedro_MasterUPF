#!/usr/bin/env python3
"""
Batch translate .qmd files from Catalan to Spanish in place using Google Translate (free)
Run this script from within the target directory (e.g., cd es/ && python3 ../python_codes/translate_to_spanish.py)
...
def main():
    ...
    # Run the unified script with Catalan -> Spanish
...
def main():
    ...
    print(f"Translation: Catalan ({SOURCE_LANG}) -> Spanish ({TARGET_LANG})\n")
