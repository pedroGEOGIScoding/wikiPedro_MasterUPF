#!/usr/bin/env python3
"""
Batch translate .qmd files from Catalan to English in place using Google Translate (free)
Run this script from within the target directory (e.g., cd en/ && python3 ../python_codes/translate_to_english_from_catalan.py)
...
def main():
    ...
    print(f"Translation: Catalan ({SOURCE_LANG}) -> English ({TARGET_LANG})\n")
