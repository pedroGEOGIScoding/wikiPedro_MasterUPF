...
if len(sys.argv) < 2:
    ...
    print("\nThis will translate the file in place (Spanish -> Catalan)")
    sys.exit(1)
...
print(f"Translating (Spanish -> Catalan): {file_path}\n")

success = translate_qmd_file(file_path, source='es', target='ca')
