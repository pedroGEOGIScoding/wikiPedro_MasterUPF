#!/usr/bin/env python3
"""
Batch translate .qmd files from Spanish to Catalan in place using Google Translate (free)
Run this script from within the target directory (e.g., cd ca/ && python3 ../python_codes/translate_to_catalan.py)
...
def main():
    ...
    # Run the unified script with Spanish -> Catalan
...
def translate_text(text, source='es', target='ca'):
