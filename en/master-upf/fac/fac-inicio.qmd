---
title: "Introduction to Fundamentals of Learning and Teaching of Natural Sciences"
...
categories: [fundamentals, learning, teaching, science]
toc: true
...
![Structure of Fundamentals of Learning and Teaching of Natural Sciences](../../images/fac/fac-structure.png){width=50% fig-align="center" group="fac-inicio"}
...
- **Nature of Science** teacher: Diego Sanjulián. How does science know what it knows? How does it construct knowledge? What are the constraints?
- **Prior Concepts** teacher: Marcel Costa. To identify the importance of starting from students' prior knowledge in the teaching-learning process.
- **Project-based/Situated Learning** Tutors: Anama Domenech and Xavi Oller. Identifying the requirements and implications of interdisciplinary project-based work and work in the science context.
- **Questions in the Science Classroom** Tutor: Pineda Badia. How do you ask the 'good' questions in the science classroom? What questions do pupils ask?
- **Modelling and school science** lecturer: Marcel Costa. To identify scientific modeling as a process used by scientists to explain reality through models, and to consider its importance in teaching and learning.
- **Out-of-classroom teaching activities** Professor: Marcel Costa. Recognizing the importance of field trips, visits to research centers and others in the teaching and learning of science.
- **Conducting research in the science classroom** Professor: Pineda Badia. Teaching and learning how to conduct research in the school setting.
- **Experimental work in science education** Professor: Xavier Muñoz. To understand the requirements for carrying out experimental work and research in science education.
- **Science and pseudoscience** Professor: Jordi de Manuel. What is pseudoscience? How can we identify it and take it into account when constructing the concept of science.
- **Addressing diversity in the classroom** lecturers: Pineda Badia, Anama Doménech, Laura Ganzer, Nora Pérez, Xavi Pié and Laura Torras. Through ABProblems, we will understand how we can cater for diversity in the classroom.
...
* The students will have at their disposal on the virtual platform the presentations and documents used during the sessions and complementary information on each topic.
...
Barberà, E., Mauri, T., Onrubia, J. 2008. How to assess the quality of teaching based on ICT. Guidelines and instruments analysis. Criticism and foundations, 19. Barcelona. Ed. Graó.
...
VVAA. 2007. Monograph: Teaching and learning by research. Alembic, 52. Barcelona. Ed. Graó.
