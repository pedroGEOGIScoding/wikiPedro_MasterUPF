...
* Este máster tiene un enfoque globalizado y holístico, con aprendizaje experiencial, colaborativo y basado en la práctica reflexiva. La participación en el prácticum en centros y el acompañamiento de los mentores son una pieza clave del crecimiento profesional, complementado con las clases en la universidad, en línea y presenciales.
...
![Ámbitos competenciales cubiertos en el máster](/images/intro-master/ambitos-competenciales.png){width=50% fig-align="center" group="intro-master-upf" loading="lazy"}

<br>

![Estructura de las asignaturas del Máster](/images/intro-master/master-estructura.png){width=50% fig-align="center" group="intro-master-upf" loading="lazy"}

<br>

![Estructura de las asignaturas del Máster en detalle](/images/intro-master/master-estructura2.png){width=50% fig-align="center" group="intro-master-upf" loading="lazy"}

<br>

![Calendario de la docencia del Máster](/images/intro-master/calendario-master.png){width=50% fig-align="center" group="intro-master-upf" loading="lazy"}
