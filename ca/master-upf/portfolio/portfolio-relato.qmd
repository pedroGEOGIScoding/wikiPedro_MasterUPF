...
# El meu relat de pràctiques (després de compartir amb els meus companys Martiña i Raúl el 19/12/2025, nous comentaris en blau clar)
## [Títol: "Sempre hi ha marge per millorar"]{style="background-color: lightskyblue; color: black;"}

[En la meva versió inicial no havia posat títol al meu relat de pràctiques, però crec que és una bona idea captar la idea global que estic intentant expressar. Aquest títol neix de la meva compartició amb els meus companys Martiña i Raúl i reflecteix la idea que sempre hi ha marge de millora i que no s'ha d'estar content per molt que les coses inicialment semblin molt bé, perquè sempre hi ha alguna cosa que es pot millorar.]{style="background-color: lightskyblue; color: black;"}
...
Per començar o obrir el meu diari d'indagació, cal enllaçar-lo amb el meu relat de la fase d'observació del pràcticum per anar definint el problema a investigar. Dins d'aquestes aules tranquil·les, com he comentat al meu relat, el que més m'ha cridat l'atenció durant aquesta fase d'observació ha estat aquesta **immiscibilitat entre sexes**. Treballar per revertir aquesta dinàmica de segregació seria la meva àrea d'interès en la qual vull centrar-me durant la fase d'intervenció.

Em sembla molt important perquè, al meu parer, si es pogués revertir aquest comportament dels alumnes, els efectes de millora repercutirien en múltiples dimensions: l'ambient de l'aula, la cohesió del grup, l'intercanvi d'idees noves i diferents entre ells i, en definitiva, un major rendiment acadèmic i millora cognitiva en exposar els alumnes a perspectives diverses més enllà del seu cercle habitual d'amics. Aquests resultats o efectes de millora potencials que espero observar em semblen prou rellevants com per implementar mesures correctores que permetin avaluar si es pot millorar el rendiment acadèmic dels treballs en grup, incrementar la cohesió del grup independentment del sexe i, en conseqüència, promoure una **millora acadèmica general**. Així doncs, el plantejament de la meva **hipòtesi és que trencar la dinàmica actual d'agrupament per sexes en els treballs en grup serà beneficiós per als alumnes en diversos aspectes: cognitiu, humà i de rendiment acadèmic**.

Per tant, després d'identificar aquest problema tant a 4t d'ESO com als dos grups de batxillerat mitjançant les meves tres setmanes d'observació, les preguntes més concretes en les quals m'agradaria treballar se centren en com intervenir a escala micro o individualitzada en l'elaboració dels grups de treball.

La solució a aquesta situació té una primera via clara: la **intervenció directa en l'elaboració de grups multinivell** creant grups heterogenis basant-me en la variable que vull treballar (*el sexe de l'alumne*) i una segona variable per equilibrar aquests grups heterogenis (*el rendiment cognitiu individual de cada alumne*). Per a aquesta segona variable, necessitaré la col·laboració d'en Carlos, ja que coneix bé els alumnes, per equilibrar cognitivament els grups. D'aquesta manera es pretén millorar el procés d'ensenyament i aprenentatge amb una millora de la pràctica docent a través de la implementació de grups heterogenis multinivell (Collicot, 1991; Tomlinson, 2008). Aquesta estratègia es fonamenta en la integració de la transposició didàctica de Chevallard (1985, 1991) i l'educació multinivell de Collicot (1991): en crear grups diversos cognitivament, es genera un escenari on el mateix contingut científic ha de ser apropiat i explicat des de múltiples nivells de comprensió dins del grup, enriquint l'aprenentatge col·lectiu. Cada alumne, des de la seva zona de desenvolupament proper (Vygotsky, 1978), contribueix amb una transposició diferenciada del coneixement, exposant els seus companys a formes diverses de construcció del saber. Així, l'heterogeneïtat cognitiva del grup no és un obstacle, sinó el motor d'una transposició didàctica multinivell on la interacció entre sexes i entre nivells de rendiment genera múltiples mediacions que, en conjunt, potencien tant la cohesió social com el desenvolupament cognitiu de tots els membres del grup (Johnson & Johnson, 1999; Slavin, 1995).

Falta desenvolupar, assumpte que treballaré amb el meu mentor de pràctiques, com categoritzarem els nivells cognitius i com es balancejarà la ***càrrega cognitiva del grup*** perquè tots els grups de treball estiguin el més equilibrats possible.

## Referències bibliogràfiques del diari d'indagació

- Vygotsky, L. S. (1978). Mind in society: The development of higher psychological processes. Cambridge, MA: Harvard University Press. (Obra original publicada el 1934).
