...
![Creació d'un nou repositori a GitHub](https://docs.github.com/assets/cb-11427/mw-1440/images/help/repository/repo-create.webp){ group="about-this-site" loading="lazy" }
...
![Configuració de pàgines de GitHub](/images/about/github-actions.png){ group="about-this-site" loading="lazy" }
...
![Execució del flux de treball de GitHub Actions](https://docs.github.com/assets/cb-31477/mw-1440/images/help/repository/actions-tab.webp){ group="about-this-site" loading="lazy" }
...
**Per a recursos en llocs multilingües:** Usa rutes absolutes des de l'arrel:
```markdown
![](/images/about/pedro.jpg)
```
No usis rutes relatives com `../images/about/pedro.jpg`
...
### 1. Estructura del Projecte Multilingüe
...
#### 2.1. Previsualització d'un Idioma Específic
...
#### 2.2. Renderitzat de Tot el Lloc
...
### 3. Sistema de Navegació entre Idiomes
...
#### 3.2. Exemple de Flux de Navegació
...
#### 3.4. La Solució: Auto-Detecció d'Entorn
...
#### 3.5. Logs de Depuració a la Consola
...
### 4. Publicació a GitHub Pages

#### 4.1. Configuració Inicial del Repositori
...
#### 4.2. Configuració de Quarto per GitHub Pages
...
#### 4.4. Verificació Post-Publicació
...
### 5. Solució de Problemes Específics de Llocs Multilingües

::: {.callout-note}
Per a problemes generals de Quarto i GitHub Pages, consulta la secció de solució de problemes de la Part 1.
:::

#### 5.1. Els Enllaços entre Idiomes No Funcionen en Local
...
#### 5.2. Els Enllaços entre Idiomes No Funcionen a GitHub Pages
...
#### 5.3. Recursos (Imatges, CSS) No Carreguen

**Símptoma**: Les imatges o estils no es mostren correctament.

**Solucions**:

1. **Usa rutes absolutes des de l'arrel**:
   ```markdown
   ![](/images/about/pedro.jpg)
   ```
   No usis rutes relatives com `../images/about/pedro.jpg`
...
#### 5.4. Canvis No Apareixen a GitHub Pages
...
#### 5.5. Depuració amb Consola del Navegador
...
- **Documentació oficial de Quarto**: [https://quarto.org](https://quarto.org)
- **GitHub Pages Docs**: [https://docs.github.com/pages](https://docs.github.com/pages)
- **Repositori del projecte**: [https://github.com/pedroGEOGIScoding/wikiPedro_MasterUPF](https://github.com/pedroGEOGIScoding/wikiPedro_MasterUPF)
